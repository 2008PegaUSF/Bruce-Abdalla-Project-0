...
public class BankApp {
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		System.out.println("Welcome! Are you a customer, employee, admin, or applicant? ");
			...
			if (signedCustomer == null) {
				...
				while (flag) {
					...
					case "withdraw":
						...
						log.trace(signedCustomer.getName() + " withdrew " + validAmount);
						break;
					case "deposit":
						System.out.println("How much would you like to deposit? ");
						double validDeposit = s.nextDouble();
						signedCustomer.deposit(validDeposit);
						log.trace(signedCustomer.getName() + " deposited " + validDeposit);
						break;
					case "transfer":
						...
						if (transferRec == null) {
							...
							log.trace(signedCustomer.getName() + " transferred " + transferAmount + " to " + transferRec.getName());
						}
						break;
					case "q":
			...
			if (signedAdmin == null) {
				...
				case "withdraw":
					...
					if (customer == null) {
						...
						log.trace(signedAdmin.getUsername() + " withdrew " + validAmount + " from " + customer.getName());
					}
					break;
				case "deposit":
					System.out.println("Enter the name of the customer: ");
					...
					if (depositcustomer == null) {
						...
						log.trace(signedAdmin.getUsername() + " deposited " + depositAmount + " into " + depositcustomer.getName() + "'s account.");
					}
					break;
				case "transfer":
					...
					log.trace(signedAdmin.getUsername() + " transferred " + validAmount + " from " + transferfromcustomer.getName() + " to " + transfertocustomer.getName());
				break;
